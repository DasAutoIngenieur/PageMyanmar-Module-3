  ...
  updateStatus == true && (
    <CButton className="form-btn" onClick={updateClick}>
      ...
      <CRow className="mt-3">
        ...
        {admin.length > 0 && (
          <>
          <p className='mb-0 font-weight-bold ml-3'>Total : {totalRow} row(s)</p>
          <div className='overflow'>
            <table className='emp-list-table'>
              <thead>
                <tr>
                  <th className="text-center" width={30} >No</th>
                  <th className='text-center' width={100}>User ID</th>
                  <th className='text-center' width={100}>Username</th>
              ...
              <tbody>
                {admin.map((data, index) => {
                  return (
                    <tr key={index}>
                      <td width={30} className="text-center">{index + 1}</td>
